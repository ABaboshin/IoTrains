...
import { TypeAttributeKind, ObjectType, EnumType, TypeAttributes, defined, UnionType, Type, messageAssert, checkStringMap, JSONSchema, Ref, JSONSchemaType, JSONSchemaAttributes, checkArray } from "quicktype-core";
import { isStringMap } from "quicktype-core/dist/support/Support";
