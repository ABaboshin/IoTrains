...
SoundTrain::SoundTrain(const std::string &id, std::uint8_t fwdPin, std::uint8_t revPin, std::uint8_t fwdLedPin, std::uint8_t revLedPin, std::uint8_t mp3Pin, const std::map<std::string, MP3File> &sounds) : Train(id, fwdPin, revPin, fwdLedPin, revLedPin), mp3("built-in", mp3Pin, sounds)
{
