...
SoundTrain::SoundTrain(std::uint8_t fwdPin, std::uint8_t revPin, std::uint8_t fwdLedPin, std::uint8_t revLedPin, std::uint8_t mp3Pin, const std::map<std::string, std::vector<unsigned char>> & sounds) : Train(fwdPin, revPin, fwdLedPin, revLedPin), mp3(mp3Pin, sounds)
{
